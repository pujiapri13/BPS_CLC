...
class TabelPdrbAdhkMLUTanpaMigas extends StatefulWidget {
  const TabelPdrbAdhkMLUTanpaMigas({super.key});

  @override
  State<TabelPdrbAdhkMLUTanpaMigas> createState() => _TabelPdrbAdhkMLUTanpaMigasState();
}

RepositoryPdrbAdhkMLU repositorypdrb = RepositoryPdrbAdhkMLU();

class _TabelPdrbAdhkMLUTanpaMigasState extends State<TabelPdrbAdhkMLUTanpaMigas> {
  @override
