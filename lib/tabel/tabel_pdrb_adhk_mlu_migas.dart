...
class TabelPdrbAdhkMLUMigas extends StatefulWidget {
  const TabelPdrbAdhkMLUMigas({super.key});

  @override
  State<TabelPdrbAdhkMLUMigas> createState() => _TabelPdrbAdhkMLUMigasState();
}

RepositoryPdrbAdhkMLU repositorypdrb = RepositoryPdrbAdhkMLU();

class _TabelPdrbAdhkMLUMigasState extends State<TabelPdrbAdhkMLUMigas> {
  @override
