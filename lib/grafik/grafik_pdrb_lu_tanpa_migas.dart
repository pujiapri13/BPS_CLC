...
class grafikPdrbLUTanpaMigas extends StatefulWidget {
  const grafikPdrbLUTanpaMigas({Key? key}) : super(key: key);

  @override
  _grafikPdrbLUTanpaMigasState createState() => _grafikPdrbLUTanpaMigasState();
}

class _grafikPdrbLUTanpaMigasState extends State<grafikPdrbLUTanpaMigas> {
