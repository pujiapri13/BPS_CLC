        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              double LkSekolah =
                  double.parse((isitenagakerja[index = 1].sekolah));
              double PrSekolah =
                  double.parse((isitenagakerja[index = 6].sekolah));
              double JmlSekolah = LkSekolah + PrSekolah;

              double LkRuta =
                  double.parse((isitenagakerja[index = 1].urus_ruta));
              double PrRuta =
                  double.parse((isitenagakerja[index = 6].urus_ruta));
              double JmlRuta = LkRuta + PrRuta;

              double LkLainnya =
                  double.parse((isitenagakerja[index = 1].lainnya));
              double PrLainnya =
                  double.parse((isitenagakerja[index = 6].lainnya));
              double JmlLainnya = LkLainnya + PrLainnya;

              double LkJumlah =
                  double.parse((isitenagakerja[index = 1].jumlah));
              double PrJumlah =
                  double.parse((isitenagakerja[index = 6].jumlah));
