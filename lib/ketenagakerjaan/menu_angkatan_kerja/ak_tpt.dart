            ...
            if (snapshot.hasData) {
              ...
              return PageView.builder(
                ...
                itemBuilder: (context, index) {
                  String th1 = isitpt[index = 4].created_at[0] +
                      isitpt[index = 4].created_at[1] +
                      isitpt[index = 4].created_at[2] +
                      isitpt[index = 4].created_at[3];
                  String th2 = isitpt[index = 3].created_at[0] +
                      isitpt[index = 3].created_at[1] +
                      isitpt[index = 3].created_at[2] +
                      isitpt[index = 3].created_at[3];
                  String th3 = isitpt[index = 2].created_at[0] +
                      isitpt[index = 2].created_at[1] +
                      isitpt[index = 2].created_at[2] +
                      isitpt[index = 2].created_at[3];
                  String th4 = isitpt[index = 1].created_at[0] +
                      isitpt[index = 1].created_at[1] +
                      isitpt[index = 1].created_at[2] +
                      isitpt[index = 1].created_at[3];
                  String th5 = isitpt[index = 0].created_at[0] +
                      isitpt[index = 0].created_at[1] +
                      isitpt[index = 0].created_at[2] +
                      isitpt[index = 0].created_at[3];

                  double lk1 = double.parse(isitpt[index = 4].lk);
                  double lk2 = double.parse(isitpt[index = 3].lk);
                  double lk3 = double.parse(isitpt[index = 2].lk);
                  double lk4 = double.parse(isitpt[index = 1].lk);
                  double lk5 = double.parse(isitpt[index = 0].lk);

                  double pr1 = double.parse(isitpt[index = 4].pr);
                  double pr2 = double.parse(isitpt[index = 3].pr);
                  double pr3 = double.parse(isitpt[index = 2].pr);
                  double pr4 = double.parse(isitpt[index = 1].pr);
                  double pr5 = double.parse(isitpt[index = 0].pr);

                  double jml1 = double.parse(isitpt[index = 4].jumlah);
                  double jml2 = double.parse(isitpt[index = 3].jumlah);
                  double jml3 = double.parse(isitpt[index = 2].jumlah);
                  double jml4 = double.parse(isitpt[index = 1].jumlah);
                  double jml5 = double.parse(isitpt[index = 0].jumlah);
