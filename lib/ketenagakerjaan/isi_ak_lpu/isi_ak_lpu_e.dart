...
class IsiAkLpuE extends StatefulWidget {
  const IsiAkLpuE({super.key});

  @override
  State<IsiAkLpuE> createState() => _IsiAkLpuEState();
}
...
class _IsiAkLpuEState extends State<IsiAkLpuE> {
  int key = 0;
  @override
        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              double taniLK = double.parse(isiaklpu[index = 0].pertanian);
              double industriLK = double.parse(isiaklpu[index = 0].industri);
              double jasaLK = double.parse(isiaklpu[index = 0].jasa);

              double taniPR = double.parse(isiaklpu[index = 5].pertanian);
              double industriPR = double.parse(isiaklpu[index = 5].industri);
              double jasPR = double.parse(isiaklpu[index = 5].jasa);
              return Column(
                children: [
                  Flexible(
                    flex: 1,
