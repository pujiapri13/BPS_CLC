...
class IsiAkLpuA extends StatefulWidget {
  const IsiAkLpuA({super.key});

  @override
  State<IsiAkLpuA> createState() => _IsiAkLpuAState();
}
...
class _IsiAkLpuAState extends State<IsiAkLpuA> {
  int key = 0;
  @override
        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              double taniLK = double.parse(isiaklpu[index = 4].pertanian);
              double industriLK = double.parse(isiaklpu[index = 4].industri);
              double jasaLK = double.parse(isiaklpu[index = 4].jasa);

              double taniPR = double.parse(isiaklpu[index = 9].pertanian);
              double industriPR = double.parse(isiaklpu[index = 9].industri);
              double jasPR = double.parse(isiaklpu[index = 9].jasa);
              return Column(
                children: [
                  Flexible(
                    flex: 1,
