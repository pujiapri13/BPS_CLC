        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              double sdLK = double.parse(isipddkpend[index = 3].sd);
              double smpLK = double.parse(isipddkpend[index = 3].smp);
              double smaLK = double.parse(isipddkpend[index = 3].sma);
              double ptLK =
                  double.parse(isipddkpend[index = 3].perguruan_tinggi);

              double sdPR = double.parse(isipddkpend[index = 8].sd);
              double smpPR = double.parse(isipddkpend[index = 8].smp);
              double smaPR = double.parse(isipddkpend[index = 8].sma);
              double ptPR =
                  double.parse(isipddkpend[index = 8].perguruan_tinggi);
