...
class IsiAkPendidikanC extends StatefulWidget {
  const IsiAkPendidikanC({super.key});

  @override
  State<IsiAkPendidikanC> createState() => _IsiAkPendidikanCState();
}
...
class _IsiAkPendidikanCState extends State<IsiAkPendidikanC> {
  int key = 0;
  @override
        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              double sdLK = double.parse(isipddkpend[index = 2].sd);
              double smpLK = double.parse(isipddkpend[index = 2].smp);
              double smaLK = double.parse(isipddkpend[index = 2].sma);
              double ptLK =
                  double.parse(isipddkpend[index = 2].perguruan_tinggi);

              double sdPR = double.parse(isipddkpend[index = 7].sd);
              double smpPR = double.parse(isipddkpend[index = 7].smp);
              double smaPR = double.parse(isipddkpend[index = 7].sma);
              double ptPR =
                  double.parse(isipddkpend[index = 7].perguruan_tinggi);
