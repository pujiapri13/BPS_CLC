...
class IsiAkUmurE extends StatefulWidget {
  const IsiAkUmurE({super.key});

  @override
  State<IsiAkUmurE> createState() => _IsiAkUmurEState();
}
...
class _IsiAkUmurEState extends State<IsiAkUmurE> {
  int key = 0;
  @override
        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              double bocahLk = double.parse(isitenagakerja[index = 0].a);
              double mudaLk = double.parse(isitenagakerja[index = 0].b);
              double tuaLk = double.parse(isitenagakerja[index = 0].c);

              double bocahPr = double.parse(isitenagakerja[index = 5].a);
              double mudaPr = double.parse(isitenagakerja[index = 5].b);
              double tuaPr = double.parse(isitenagakerja[index = 5].c);
              return Column(
                children: [
                  Flexible(
                    flex: 1,
